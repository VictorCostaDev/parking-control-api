...
public class ParkingSpotModel implements Serializable {
    private static final long serialVersionUID = 1L;  // Ajuda no processo da jvm para o banco de dados

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)  // O id sera gerado automaticamente
    private UUID id;
    ...
    private String responsibleName;  // nome de responsavel
